...
const { listRepositories, getRepositoryDetails, getTagDetails, deleteTag, deleteRepository, getStatistics, triggerGC, scanImage, getScanStatus } = require('../controllers/registryController');
...
router.delete('/repositories/:name', authenticateToken(['admin']), deleteRepository);
